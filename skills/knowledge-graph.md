...
metadata:
  hermes:
    tags: [research, knowledge-management, synthesis]
    related_skills: [citation-manager, source-analyzer, fact-checker]
    session_unlock: session-8
    tiers:
      - L1: Manual relationship mapping between concepts
      - L2: Automatic inference + pattern detection
      - L3: Predictive insights + gap identification
---
