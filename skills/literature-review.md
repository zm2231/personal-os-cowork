...
metadata:
  hermes:
    ...
    related_skills: [citation-manager, knowledge-graph, academic-writing]
    session_unlock: session-22
    tiers:
      - L1: Guided literature search and manual synthesis
      - L2: Automated citation extraction and thematic analysis
      - L3: Systematic review protocols + meta-analysis
---
