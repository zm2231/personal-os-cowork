...
metadata:
  hermes:
    tags: [research, critical-thinking, credibility]
    related_skills: [fact-checker, citation-manager, knowledge-graph]
    session_unlock: session-6
    tiers:
      - L1: Basic credibility assessment (domain, author, publication)
      - L2: Bias detection + source comparison
      - L3: Trust scoring + automated monitoring
---
