---
name: domain-list
description: "Trigger when: 'Show me all my domains', 'What domains do I have?', 'List my domains'. Lists all active domains with quick summaries and status."
version: 1.0.0
metadata:
  hermes:
    tags: [domains, context-awareness, overview]
---
