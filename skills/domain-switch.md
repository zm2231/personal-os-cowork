---
name: domain-switch
description: "Trigger when: 'Switch to X domain', 'I'm working on Y now', 'Change context to...'. Explicitly switches active domain. Note: 95%+ of switches happen automatically via context-aware-router - this is for edge cases."
version: 1.0.0
metadata:
  hermes:
    tags: [domains, context-switching, explicit]
---
...
Path: ~/.hermes/personal-os/{type}/{domain-name}/
