...
metadata:
  hermes:
    ...
    related_skills: [hypothesis-testing, data-analysis, research-methods]
    session_unlock: session-22
    tiers:
      - L1: Guided experiment design with basic controls
      - L2: Advanced designs (factorial, within-subjects, mixed)
      - L3: Complex field experiments + quasi-experimental designs
---
