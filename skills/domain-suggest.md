---
name: domain-suggest
description: "Trigger when: User works on a new area repeatedly. Pattern-based detection suggests new domains from conversation history and usage patterns. Runs automatically or on explicit request."
version: 1.0.0
metadata:
  hermes:
    tags: [domains, pattern-detection, auto-discovery]
---
