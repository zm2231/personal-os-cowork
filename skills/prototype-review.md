...
description: Provide comprehensive design feedback on prototypes, wireframes, and mockups with actionable insights
...
- **Visual Hierarchy**: Evaluate information architecture and visual priority
- **Layout & Spacing**: Check alignment, balance, and whitespace usage
- **Typography**: Assess font choice, size, weight, and readability
- **Color Usage**: Review color palettes, contrast, and accessibility
- **User Flow**: Analyze navigation patterns and interaction clarity
- **Component Consistency**: Identify inconsistencies in component usage
- **Basic Usability**: Catch obvious usability issues and friction points
...
- **Interaction Design**: Evaluate micro-interactions, animations, and feedback
- **Accessibility Audit**: Check WCAG compliance and inclusive design
- **Responsive Design**: Review breakpoints, mobile adaptation, and cross-device consistency
- **Design System Alignment**: Verify compliance with design system components and tokens
- **Psychological Principles**: Apply Gestalt principles, cognitive load theory, and heuristics
- **Competitive Analysis**: Compare with industry best practices and competitors
- **Quantitative Feedback**: Provide prioritized, actionable recommendations with severity ratings
- **Design Patterns**: Identify design patterns and suggest improvements or alternatives
...
- **Design Metrics Integration**: Define and track design quality metrics (success rate, time-on-task, error rates)
- **A/B Test Planning**: Design A/B test variants and success metrics
- **User Research Synthesis**: Integrate user research findings into design recommendations
- **Design System Evolution**: Identify opportunities to extend or improve the design system
- **Design Debt Analysis**: Quantify design debt and create remediation roadmaps
- **Cross-Product Consistency**: Ensure design consistency across multiple products and touchpoints
- **Design Operations**: Create workflows, processes, and tools for systematic design review
- **Team Design Maturity**: Assess and improve team design capabilities and processes

**Example:**
``
"We're launching a new product line and need comprehensive design leadership. Help me:
1. Define design quality KPIs and establish measurement baseline
2. Create a design review workflow that ensures consistent quality
3. Analyze design debt across our existing products and create a remediation roadmap
4. Design A/B test variants for our key conversion funnel (4 variants, 3 success metrics)
5. Synthesize user research findings into actionable design improvements
6. Identify gaps in our design system and create a plan to fill them
7. Establish cross-product design consistency guidelines
8. Assess our team's design maturity and create a capability-building plan
9. Build a design ops toolkit for systematic design review and improvement"
```
...
- **Prerequisites**: Strong understanding of UX design principles, accessibility standards, and design systems
