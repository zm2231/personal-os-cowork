...
Reads `personal-os/context/identity.md` and recommends the most useful skills to start with based on role. All 83 skills are already available — this just surfaces the highest-signal ones.
...
All 83 skills are available — use /skill-suggester to browse or just
