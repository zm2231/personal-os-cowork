---
name: domain-create
description: "..', 'Track this separately'. Creates a new domain file with user-defined or AI-suggested context."
---
...
personal-os/domains/{domain-type}/{domain-name}/
...
```bash
# Create directory
mkdir -p personal-os/domains/{domain-type}/{domain-name}
...
Path: personal-os/domains/{domain-type}/{domain-name}/
```
