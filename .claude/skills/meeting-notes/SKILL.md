---
name: meeting-notes
description: "Captures, organizes, and synthesizes meeting notes with automatic action item extraction and key takeaways."
---
...
Full notes saved to: personal-os/logs/meetings/q1-performance-review-2026-03-27.md
```
...
1. Review PR #234 for main branch merge
   ...
   - Due: March 28
   - Priority: High
   - Context: "Alex, can you review that PR today or tomorrow?"
...
**Attendees:** Sarah (Finance), James (Product), Lisa (Operations), Alex (Engineering)
...
- Alex (Engineering): 9 minutes, 3 points
...
1. Review PR #234
   ...
   - Escalation: Sent reminder to Alex, flagged in team sync
