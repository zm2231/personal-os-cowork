...
triggers:
  - Weekly automatic review (after pattern-detect runs)
  - User says "any suggestions?", "recommend something", "what should I improve?"
  - Pattern crosses confidence threshold for specific recommendation
frequency: weekly
---
